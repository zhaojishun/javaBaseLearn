...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * 5、只输出一个用户！
         */
        User u1 = User.builder().id(1).name("张三").age(15).build();
        User u2 = User.builder().id(2).name("李四").age(18).build();
        User u3 = User.builder().id(3).name("王五").age(80).build();
        User u4 = User.builder().id(4).name("赵六").age(2).build();
        User u5 = User.builder().id(5).name("田七").age(7).build();
